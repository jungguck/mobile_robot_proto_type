...
> **📖 먼저 읽을 것: `docs/DEBUG_LOG_<가장 최신 날짜>.md`**
> 현재 상태·미결 항목·다음 할 일이 거기 0절에 있습니다. 이 README 는 절차서이고,
> **무엇이 지금 막혀 있는지는 docs 가 정본**입니다. (`docs/wiki/index.md` 가 전체 지도)
>
> ⏳ **2026-09-22 기준 젯슨에 빌드가 안 돼 있습니다.** 실기 작업은 거기서부터 시작합니다.
